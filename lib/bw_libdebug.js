...
const WD_ON         = 0;
const WD_OFF        = 1;
const WD_NC         = 2;  // No change (take over ON/OFF state from parent level)
const WD_FORCE      = 3;  // Force debug output (not used?)
...
console.log('[DBG] lib/bw_libdebug.js loaded ...');
