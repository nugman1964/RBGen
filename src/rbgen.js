...
function RBG_OnClick(eElement)
{
  ...
  switch (sElementID) {
    case 'RBG.Nav.Edit':
      ...
      var CoverWnd = TestPage1Elem.Add(new RBG_ElementRect_C('Window', 10,100,nSheetWidth,243-100,'mm'));
      ...
      var CoverDatum = TestPage1Elem.Add(new RBG_ElementText_C('RB',-(100+243)/2,nSheetWidth-17-3,0,0,'mm'));
      ...
      // Titelthema
      var CoverImgSt2000 = TestPage1Elem.Add(new RBG_ElementImage_C('Stempel2000',22+13,140+18,0,0,'mm'));
      CoverImgSt2000.SetFilename('./img/ArGePH.Stempel.2000.jpg');
      var CoverImgSt2025 = TestPage1Elem.Add(new RBG_ElementImage_C('Stempel2000',100+13,139+18,0,0,'mm'));
      CoverImgSt2025.SetFilename('./img/ArGePH.Stempel.2025.jpg');
      var Cover25Jahre = TestPage1Elem.Add(new RBG_ElementText_C('RB',nSheetWidth/2,100+18,0,0,'mm'));
